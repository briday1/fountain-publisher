...
- All 125 contract tests, the production build, and 16 local native Chrome browser regressions passed. The browser suite covers title-page editing without undo resets, exact beat ranges, the writing guide, cumulative pacing, cast/scene/act analytics, individual dialogue navigation, PDF-derived page counts, PNG exports, and desktop/mobile layouts.
...
- PDF page counters are checked against downloaded PDFs before opening preview, including title pages, explicit breaks, continued dialogue, and Letter/A4 geometry.
